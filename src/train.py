...
def main():
    ...
    trainset = ASEDataset(args.data_dir_train, args.atom_embed,True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir_train', nargs='+', default=['/data/cb_dataset/train.db'], type=str,
                        help='List of training data directories (space-separated). Example: --data_dir_train /path/to/train1.db /path/to/train2.db')
    parser.add_argument('--data_dir_val', nargs='+', default=['/data/cb_dataset/val.db'], type=str,
                        help='List of validation data directories (space-separated). Example: --data_dir_val /path/to/val.db')
